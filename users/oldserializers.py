...
# class RecruiterRequestPasswordResetEmailSerializer(serializers.Serializer):
#     email = serializers.EmailField(min_length = 2)

#     class Meta:
#         fields = ['email']

# class RecruiterPasswordTokenConfirmSerializer(serializers.Serializer):
#     uidb64 = serializers.CharField(min_length = 1, write_only = True)
#     token = serializers.CharField(min_length = 1, write_only = True)
...
# class RecruiterSetNewPasswordSerializer(serializers.Serializer):
#     password = serializers.CharField(min_length = 6, max_length=68, write_only = True)
#     uidb64 = serializers.CharField(min_length = 1, write_only = True)
#     token = serializers.CharField(min_length = 1, write_only = True)
...
# class RecruiterLogOutSerializer(serializers.Serializer):
#     refresh = serializers.CharField()
...
# class CandidatesEmailVerificationSerializer(serializers.ModelSerializer):
#     token = serializers.CharField(max_length = 555)
...
# class CandidatesLoginSerializer(serializers.ModelSerializer):
#     email = serializers.EmailField(max_length=255, min_length=4)
#     password = serializers.CharField(max_length=68, min_length=6, write_only=True)
#     username = serializers.CharField(max_length=68, min_length=3, read_only=True)
#     tokens = serializers.CharField(max_length=68, min_length=3, read_only=True)
...
# class CandidateRequestPasswordResetEmailSerializer(serializers.Serializer):
#     email = serializers.EmailField(min_length = 2)

#     class Meta:
#         fields = ['email']

# class CandidatePasswordTokenConfirmSerializer(serializers.Serializer):
#     uidb64 = serializers.CharField(min_length = 1, write_only = True)
#     token = serializers.CharField(min_length = 1, write_only = True)
...
# class CandidateSetNewPasswordSerializer(serializers.Serializer):
#     password = serializers.CharField(min_length = 6, max_length=68, write_only = True)
#     uidb64 = serializers.CharField(min_length = 1, write_only = True)
#     token = serializers.CharField(min_length = 1, write_only = True)
...
# class CandidateLogOutSerializer(serializers.Serializer):
#     refresh = serializers.CharField()
