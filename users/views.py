...
from users.serializers import  RegisterSerializer, RecruiterRegisterSerializer, CandidateRegisterSerializer, EmailVerificationSerializer, LoginSerializer, RequestPasswordResetEmailSerializer, SetNewPasswordSerializer, LogOutSerializer, PasswordTokenConfirmSerializer, RecruiterEmailVerificationSerializer, RecruiterLoginSerializer, RecruiterRequestPasswordResetEmailSerializer, RecruiterPasswordTokenConfirmSerializer, RecruiterSetNewPasswordSerializer, RecruiterLogOutSerializer, CandidatesEmailVerificationSerializer, CandidatesLoginSerializer, CandidateRequestPasswordResetEmailSerializer, CandidatePasswordTokenConfirmSerializer, CandidateSetNewPasswordSerializer, CandidateLogOutSerializer
